...
import { values as defaults } from '../content-06-example'

import type { Content06Props } from '../content-06'

interface Content06EditorFieldsProps {
  props?: Content06Props
  onUpdate?: (props: Content06Props) => void
}

export function Content06EditorFields({
  props: externalProps,
  onUpdate,
}: Content06EditorFieldsProps = {}) {
  const [internalProps, setInternalProps] =
    React.useState<Content06Props>(defaults)
