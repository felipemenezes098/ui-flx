...
export interface Content10Props {
  ...
  description?: string
  items: Content10Item[]
  selectedItem?: Content10Item | null
  onSelectedItemChange?: (item: Content10Item | null) => void
}
