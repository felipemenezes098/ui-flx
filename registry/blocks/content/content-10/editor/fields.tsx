...
import type { Content10Props } from '../content-10'

interface Content10EditorFieldsProps {
...
export function Content10EditorFields({
  props: externalProps,
  onUpdate,
}: Content10EditorFieldsProps = {}) {
  const [internalProps, setInternalProps] =
    React.useState<Content10Props>(defaults)

  const props = externalProps ?? internalProps

  const updateField = (
    field: keyof Content10Props,
    value: unknown,
  ) => {
