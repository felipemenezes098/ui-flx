...
import { values as defaults } from '../showcase-01-example'

import type { Showcase01Props } from '../showcase-01'

interface Showcase01EditorFieldsProps {
  props?: Showcase01Props
  onUpdate?: (props: Showcase01Props) => void
}

export function Showcase01EditorFields({
  props: externalProps,
  onUpdate,
}: Showcase01EditorFieldsProps = {}) {
  const [internalProps, setInternalProps] =
    React.useState<Showcase01Props>(defaults)
  ...
  const updateCta = (field: string, value: any) => {
    ...
    const newProps: Showcase01Props = {
      ...props,
