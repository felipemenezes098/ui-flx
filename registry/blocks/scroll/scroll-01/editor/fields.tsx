...
import { values as defaults } from '../scroll-01-example'

import type { Scroll01Props } from '../scroll-01'

interface Scroll01EditorFieldsProps {
  props?: Scroll01Props
  onUpdate?: (props: Scroll01Props) => void
}

export function Scroll01EditorFields({
  props: externalProps,
  onUpdate,
}: Scroll01EditorFieldsProps = {}) {
  const [internalProps, setInternalProps] =
    React.useState<Scroll01Props>(defaults)
