import {
  StickyScrollMedia,
  type StickyScrollMediaProps,
} from './sticky-scroll-media'
...
} satisfies StickyScrollMediaProps

export function StickyScrollMediaExample() {
  return (
    <div>
      <div className="h-10" />
      <StickyScrollMedia items={values.items} />
      <div className="h-30" />
    </div>
  )
}
