...
interface CarouselMediaEditorFieldsProps {
  ...
  onUpdate?: (props: CarouselMediaProps) => void
}

export function CarouselMediaEditorFields({
  props: externalProps,
  onUpdate,
}: CarouselMediaEditorFieldsProps = {}) {
  const [internalProps, setInternalProps] =
    React.useState<CarouselMediaProps>(defaults)
