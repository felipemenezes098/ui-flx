...
import { values as defaults } from '../carousel-03-example'

import type { CarouselCardItem, Carousel03Props } from '../carousel-03'

interface Carousel03EditorFieldsProps {
  props?: Carousel03Props
  onUpdate?: (props: Carousel03Props) => void
}

export function Carousel03EditorFields({
  props: externalProps,
  onUpdate,
}: Carousel03EditorFieldsProps = {}) {
  const [internalProps, setInternalProps] = React.useState<Carousel03Props>(
    defaults as Carousel03Props,
  )

  const props = externalProps ?? internalProps

  const updateField = (
    field: keyof Carousel03Props,
  ...
  const addItem = () => {
    const newProps: Carousel03Props = {
      ...props,
      items: [
        ...props.items,
        {
