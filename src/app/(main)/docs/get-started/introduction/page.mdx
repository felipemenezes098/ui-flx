...
It's built on [shadcn/ui](https://ui.shadcn.com) and Tailwind so blocks look good together. The docs are about Flx: what’s here and how to use it. You can integrate easily with Sanity using the docs we provide, or with any other CMS by following the same props-based approach. If you're not using a CMS, you can pass data straight from your code.
