...
import { DecisionCopyActions } from './decision-copy-actions'
  ...
  return (
    <section className="flex flex-col gap-5">
      ...
      <div className="grid auto-rows-fr grid-cols-1 gap-4 sm:grid-cols-2">
        {items.map(({ slug, name, best, caveat, demo: Demo, prompt, install }) => (
          <div
            key={slug}
          ...
          >
            ...
            <div className="flex flex-col gap-3 px-1.5 pb-1.5">
              ...
              <DecisionCopyActions prompt={prompt} install={install} />
            </div>
          </div>
        ))}
      </div>
