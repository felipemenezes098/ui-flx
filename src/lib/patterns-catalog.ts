    ...
    items: [
      {
        slug: 'card-01',
        name: 'Basic',
        description: 'Header, action, content, and a bordered footer.',
      },
      {
        slug: 'card-02',
        name: 'With image',
      ...
      },
      {
        slug: 'card-03',
        name: 'Horizontal',
        description: 'Image on the left beside a category, title, and link.',
      },
      {
        slug: 'card-04',
        name: 'With action menu',
        description:
          'CardAction hosts a dropdown of rename, share, and delete.',
      },
      {
        slug: 'card-05',
        name: 'Stat',
        description: 'KPI value with an icon and a tinted trend badge.',
      },
      {
        slug: 'card-06',
        name: 'Login form',
      ...
      },
      {
        slug: 'card-10',
        name: 'Product',
        description: 'Square image with a sale badge, price, and add-to-cart.',
      },
      {
        slug: 'card-11',
        name: 'Notification settings',
        description: 'Horizontal field rows each toggled with a switch.',
      },
      {
        slug: 'card-12',
        name: 'Selectable',
      ...
      },
      {
        slug: 'card-13',
        name: 'Image overlay',
        description: 'Text and a CTA over a gradient-darkened cover image.',
      },
      {
        slug: 'card-14',
        name: 'Payment form',
        description: 'Card number group, expiry, CVC, and country select.',
      },
    ],
  },
  {
