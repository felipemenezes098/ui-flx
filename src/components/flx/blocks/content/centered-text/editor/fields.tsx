...
interface CenteredTextEditorFieldsProps {
  ...
  onUpdate?: (props: CenteredTextProps) => void
}

export function CenteredTextEditorFields({
  props: externalProps,
  onUpdate,
}: CenteredTextEditorFieldsProps = {}) {
  const [internalProps, setInternalProps] = React.useState<CenteredTextProps>({
  ...
  const updateCta = (field: string, value: any) => {
    ...
    const newProps: CenteredTextProps = {
      ...props,
